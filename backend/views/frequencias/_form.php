...
<div class="frequencias-form">
    ...
    <div class = "row">
        <?php echo $form->field($model, 'codigoOcorrencia' , ['options' => ['class' => 'col-md-6', 'id' => 'listaOcorrencias']])->dropDownlist($listData, ['prompt' => 'Selecione um código de Ocorrência'])->label("<font color='#FF0000'>*</font> <b>Código da Ocorrência:</b>");?>
    </div>

    <div class = "row">
        <?php echo $form->field($model, 'qtdDiasPagamento' , ['options' => ['class' => 'col-md-6', 'id' => 'qtdDiasPagamento']])->textInput(['min' => 0, 'max' => 30])->label("<font color='#FF0000'>*</font> <b>Quantidade de dias para pagamento:</b>");?>
    </div>
